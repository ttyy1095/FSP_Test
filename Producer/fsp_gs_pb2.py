...
_PROTODICTIONARY = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Enum2AppPresetBit', index=11, number=4010,
      options=None,
      type=None),
  ],
...
_PRESETBITACTION = _descriptor.Descriptor(
  name='PresetBitAction',
  full_name='com.fsmeeting.fsp.proto.gs.PresetBitAction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='group_id', full_name='com.fsmeeting.fsp.proto.gs.PresetBitAction.group_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='user_id', full_name='com.fsmeeting.fsp.proto.gs.PresetBitAction.user_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='media_type', full_name='com.fsmeeting.fsp.proto.gs.PresetBitAction.media_type', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='preset_type', full_name='com.fsmeeting.fsp.proto.gs.PresetBitAction.preset_type', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PRESETBITACTION.fields_by_name['media_type'].enum_type = fsp__common__pb2._MEDIATYPE
_PRESETBITACTION.fields_by_name['preset_type'].enum_type = fsp__common__pb2._PRESETTYPE
...
DESCRIPTOR.message_types_by_name['PresetBitAction'] = _PRESETBITACTION
...
PresetBitAction = _reflection.GeneratedProtocolMessageType('PresetBitAction', (_message.Message,), dict(
  DESCRIPTOR = _PRESETBITACTION,
  __module__ = 'fsp_gs_pb2'
  # @@protoc_insertion_point(class_scope:com.fsmeeting.fsp.proto.gs.PresetBitAction)
  ))
_sym_db.RegisterMessage(PresetBitAction)
