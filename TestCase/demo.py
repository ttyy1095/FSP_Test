...
ssh.connect(hostname='192.168.7.70', port=22, username="root", password="123456")
stdin,stdout,stderr = ssh.exec_command("cd /etc/ansible/jenkins_deploy/autotest && ansible-playbook -i inventories/hosts start_gc.yml")
